...
<head>
    ...
    <title>Cambiar Contraseña — RestaurantChain</title>
...
<div class="reset-card">
    ...
    <h4 class="text-white text-center mb-4">Cambiar contraseña</h4>

    <div class="warning-box">
        <i class="bi bi-exclamation-triangle-fill me-2"></i>
        <strong>El administrador reseteó tu contraseña.</strong>
        <br>Por seguridad debes crear una nueva antes de continuar.
    </div>
